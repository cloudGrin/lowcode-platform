...
export interface ApiPageVersionPageVersion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    operator: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    baseVersion: Attribute.Relation<
      'api::page-version.page-version',
      'oneToOne',
      'api::page-version.page-version'
    >;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    appId: Attribute.UID & Attribute.Required;
    status: Attribute.Enumeration<['ONLINE', 'DELETE']> &
      Attribute.Required &
...
export interface ApiProjectRouteProjectRoute extends Schema.CollectionType {
  ...
  attributes: {
    ...
    navUuid: Attribute.UID & Attribute.Required;
    type: Attribute.Enumeration<['NAV', 'PAGE', 'LINK']> & Attribute.Required;
    parentNavUuid: Attribute.String & Attribute.Required;
    url: Attribute.String;
    listOrder: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 0;
      }>;
    project: Attribute.Relation<
      ...
      'api::project.project'
    >;
    isNewPage: Attribute.Boolean & Attribute.DefaultTo<false>;
    status: Attribute.Enumeration<['ONLINE', 'DELETE']> &
      Attribute.Required &
      Attribute.DefaultTo<'ONLINE'>;
...
export interface ApiProjectUserRoleProjectUserRole
  extends Schema.CollectionType {
  ...
  attributes: {
    projectRole: Attribute.Relation<
      'api::project-user-role.project-user-role',
      'oneToOne',
      'api::project-role.project-role'
    >;
    project: Attribute.Relation<
...
export interface ApiProjectVersionProjectVersion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    project: Attribute.Relation<
      ...
      'api::project.project'
    >;
    navList: Attribute.JSON & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::project-route.project-route': ApiProjectRouteProjectRoute;
      'api::project-user-role.project-user-role': ApiProjectUserRoleProjectUserRole;
      'api::project-version.project-version': ApiProjectVersionProjectVersion;
    }
  }
}
