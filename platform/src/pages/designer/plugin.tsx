...
import { getPageSchema, saveSchema, resetSchema, preview, getProjectSchemaFromLocalStorage } from './universal/utils'
    ...
    return {
      ...
      async init() {
        ...
        skeleton.add({
          ...
          content: <Button onClick={() => saveSchema('basic-antd')}>保存到本地</Button>
        })
        skeleton.add({
          name: 'resetSchema',
          area: 'topArea',
          ...
          content: <Button onClick={() => resetSchema('basic-antd')}>重置页面</Button>
        })
